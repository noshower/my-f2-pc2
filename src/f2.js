(function(global, factory) {
  ...
  ***************************************************************************** */
  ...
  var systemInfo = typeof my === 'object' ? get(my, 'getSystemInfoSync', noop)() || {} : {};
  var app = systemInfo.app,
    brand = systemInfo.brand;
  var isPcQianNiu = app === 'qianniu' && brand === 'windows';

  var startEvent = isPcQianNiu ? 'mousedown' : 'touchstart';
  var processEvent = isPcQianNiu ? 'mousemove' : 'touchmove';
  var endEvent = isPcQianNiu ? 'mouseup' : 'touchend';
  ...
  var EventController = /*#__PURE__*/ (function() {
    function EventController(_ref) {
      ...
      _defineProperty(
        ...
        /*#__PURE__*/ (function() {
          var _ref2 = _asyncToGenerator(
            /*#__PURE__*/ regeneratorRuntime.mark(function _callee(ev) {
              var points;
              return regeneratorRuntime.wrap(function _callee$(_context) {
                while (1) {
                  switch ((_context.prev = _context.next)) {
                    case 0:
                      _context.next = 2;
                      return convertPoints(ev, _this.canvas);
      ...
      _defineProperty(
        ...
        /*#__PURE__*/ (function() {
          var _ref3 = _asyncToGenerator(
            /*#__PURE__*/ regeneratorRuntime.mark(function _callee2(ev) {
              var points;
                ...
                while (1) {
                  switch ((_context2.prev = _context2.next)) {
                    ...
                    case 5:
                      ...
                      _this.emitEvent(startEvent, ev); // 防止上次的内容没有清理掉，重新reset下
      ...
      _defineProperty(
        ...
        /*#__PURE__*/ (function() {
          var _ref4 = _asyncToGenerator(
            /*#__PURE__*/ regeneratorRuntime.mark(function _callee3(ev) {
              var points,
                startPoints,
                startDistance,
                currentDistance,
                ...
                while (1) {
                  switch ((_context3.prev = _context3.next)) {
                    ...
                    case 5:
                      ...
                      _this.emitEvent(processEvent, ev);
                    ...
                    case 11:
                      ...
                      if (points.length > 1) {
                        ...
                        deltaX = points[0].x - startPoints[0].x;
                        deltaY = points[0].y - startPoints[0].y;
                        direction = _this.direction || calcDirection(startPoints[0], points[0]);
                        _this.direction = direction; // 获取press或者pan的事件类型
                        // press 按住滑动, pan表示平移
                        // 如果start后立刻move，则触发pan, 如果有停顿，则触发press

                        eventType = _this.getEventType(points);
                        ev.direction = direction;
                        ev.deltaX = deltaX;
                        ev.deltaY = deltaY;
                        ...
                        prevMoveTime = _this.lastMoveTime;
                        now = Date.now(); // 最后2次的时间间隔一定要大于0，否则swipe没发计算
      ...
      _defineProperty(this, '_end', function(ev) {
        ...
        _this.emitEvent(endEvent, ev); // swipe事件处理, 在touchend之后触发
    ...
    _proto.delegateEvent = function delegateEvent(canvasEl) {
      ...
      canvasEl.addEventListener(startEvent, this._start);
      canvasEl.addEventListener(processEvent, this._move);
      canvasEl.addEventListener(endEvent, this._end);
  ...
  var LegendController = /*#__PURE__*/ (function() {
    ...
    _proto.bindEvents = function bindEvents() {
      ...
      var triggerOn = legendCfg.triggerOn || startEvent;
  ...
  */
  ...
  var Base$2 = /*#__PURE__*/ (function() {
    ...
    function Base(cfg, chart) {
      ...
      _defineProperty(this, 'startEvent', startEvent);

      _defineProperty(this, 'processEvent', processEvent);

      _defineProperty(this, 'endEvent', endEvent);
